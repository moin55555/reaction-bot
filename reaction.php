...
* Shared by Agus
* FB : http://on.fb.me/1ntU3H5
* Free Script, dont sell it!!
*** NOTE , Just fill your Facebook login data and choose your reaction type. ***

****** DON'T REMOVE THE OWNER IDENTITY! ****** 
* Terimakasih
...
(+) true : for enable.
(+) false : for disable.
(+) PLEASE SELECT ONLY ONE OF TYPES,because if more than one, it willn't work !!
*/
      'suka' => false, //like
       'super' => false, //love
        'haha' => false, //haha
